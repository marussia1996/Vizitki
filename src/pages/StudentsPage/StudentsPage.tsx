                    ...
                    {isEmptyTable ? (
                        ...
                        <>
                            <Scroll mix={styles.ScrollCommentTable}>
                                <Table>
                                    <Thead>
                                        <Th onClick={(event) => { handleClickSort('cohort') }}>{'Номер кагорты'}</Th>
                                        <Th onClick={(event) => { handleClickSort('email') }}>{'E-mail'}</Th>
                                        <Th onClick={(event) => { handleClickSort('name') }}>{'Имя и фамилия студента'}</Th>
                                        <Th> </Th>
                                    </Thead>
                                    <Tbody>
